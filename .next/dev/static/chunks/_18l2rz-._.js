...
function EmergencyScreen({ lang, back }) {
    ...
    const handleVoiceSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EmergencyScreen.useCallback[handleVoiceSearch]": ()=>{
            if (listening) {
                stop();
                return;
            }
            start({
                "EmergencyScreen.useCallback[handleVoiceSearch]": (text)=>setSearchInput(text)
            }["EmergencyScreen.useCallback[handleVoiceSearch]"]);
        }
    }["EmergencyScreen.useCallback[handleVoiceSearch]"], [
        listening,
...
_s(EmergencyScreen, "s4AT6xgmnByJ7roUAY/v4tY/mds=", false, function() {
    return [
...
_s(SchemesScreen, "OHkdjmVhDElV66Fe3/HD116MN1c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$voice$2d$search$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVoiceSearch"]
    ];
});
...
//# sourceMappingURL=_18l2rz-._.js.map