...
_s(NearbyMap, "nJ9sAI0+ip2ZHg03umLU1QNgQ10=");
_c = NearbyMap;
var _c;
...
function NearbyScreen({ lang, back, online }) {
    ...
    const [stateSel, setStateSel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [districtSel, setDistrictSel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [villageSel, setVillageSel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [searchInput, setSearchInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
        ...
        "NearbyScreen.useCallback[requestLocation]": ()=>{
            ...
            navigator.geolocation.getCurrentPosition({
                "NearbyScreen.useCallback[requestLocation]": (pos)=>{
                    const dId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nearestDistrictId"])(pos.coords.latitude, pos.coords.longitude) ?? 'pune';
                    applyLoc({
    ...
    const chooseDistrict = (id)=>{
        setDistrictSel(id);
        setVillageSel('');
        const d = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DISTRICTS"][id];
        if (d) applyLoc({
            lat: d.center.lat,
            lng: d.center.lng,
            districtId: id
    ...
    const chooseVillage = (id)=>{
        setVillageSel(id);
        const d = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DISTRICTS"][districtSel];
    ...
    const districtOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[districtOptions]": ()=>{
            const st = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATES"].find({
                "NearbyScreen.useMemo[districtOptions].st": (s)=>s.id === stateSel
            }["NearbyScreen.useMemo[districtOptions].st"]);
            return st ? st.districts.map({
                "NearbyScreen.useMemo[districtOptions]": (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DISTRICTS"][id]
            }["NearbyScreen.useMemo[districtOptions]"]).filter(Boolean) : [];
        }
    }["NearbyScreen.useMemo[districtOptions]"], [
        stateSel
    ]);
    ...
    const locLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[locLabel]": ()=>{
            if (!loc) return '';
            const d = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DISTRICTS"][loc.districtId];
            if (!d) return 'GPS';
            if (loc.villageId) {
                const v = d.villages.find({
                    "NearbyScreen.useMemo[locLabel].v": (x)=>x.id === loc.villageId
                }["NearbyScreen.useMemo[locLabel].v"]);
    ...
    const allPlaces = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[allPlaces]": ()=>loc?.districtId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDistrictPlaces"])(loc.districtId) : []
    }["NearbyScreen.useMemo[allPlaces]"], [
        loc?.districtId
    ]);
    const withDist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[withDist]": ()=>{
            if (!loc) return [];
            return allPlaces.map({
                "NearbyScreen.useMemo[withDist]": (p)=>({
                        p,
            ...
            }["NearbyScreen.useMemo[withDist]"]).sort({
                "NearbyScreen.useMemo[withDist]": (a, b)=>a.km - b.km
            }["NearbyScreen.useMemo[withDist]"]);
        }
    }["NearbyScreen.useMemo[withDist]"], [
        allPlaces,
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[filtered]": ()=>{
            ...
            if (filter !== 'All') list = list.filter({
                "NearbyScreen.useMemo[filtered]": (x)=>x.p.type === filter
            }["NearbyScreen.useMemo[filtered]"]);
            if (q) {
                list = list.filter({
                    "NearbyScreen.useMemo[filtered]": (x)=>{
                        const cat = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find({
                            "NearbyScreen.useMemo[filtered].cat": (c)=>c.id === x.p.type
                        }["NearbyScreen.useMemo[filtered].cat"]);
                        const haystack = [
                            x.p.name,
                            cat?.label.mr,
                            cat?.label.hi,
    ...
    const nearestOf = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NearbyScreen.useCallback[nearestOf]": (type)=>withDist.find({
                "NearbyScreen.useCallback[nearestOf]": (x)=>x.p.type === type
            }["NearbyScreen.useCallback[nearestOf]"])?.p ?? null
    }["NearbyScreen.useCallback[nearestOf]"], [
        withDist
    ]);
    const sosVetPhone = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NearbyScreen.useMemo[sosVetPhone]": ()=>nearestOf('vet')?.phone ?? '1962'
    }["NearbyScreen.useMemo[sosVetPhone]"], [
        nearestOf
    ]);
    ...
    const handleVoiceResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NearbyScreen.useCallback[handleVoiceResult]": (text)=>{
            ...
            setSelectedId(null);
            const has = {
                "NearbyScreen.useCallback[handleVoiceResult].has": (...kw)=>kw.some({
                        "NearbyScreen.useCallback[handleVoiceResult].has": (k)=>t.includes(k)
                    }["NearbyScreen.useCallback[handleVoiceResult].has"])
            }["NearbyScreen.useCallback[handleVoiceResult].has"];
    ...
    const readSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NearbyScreen.useCallback[readSummary]": ()=>{
            if (!loc || isSpeaking) {
                stopSpeaking();
                return;
            }
            const parts = [
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].listenIntro[lang]
            ];
            for (const { p, km } of filtered.slice(0, 4)){
                const st = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openStatus"])(p, new Date());
                parts.push(`${p.name}. ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistance"])(km, lang)} ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].kilometreAway[lang]} ${st === 'open' ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].openNowText[lang] : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].closedNowText[lang]}`);
            }
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    showDropdowns && !loc ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].chooseManually[lang]
                                    }, void 0, false, {
                                        fileName: "[project]/components/screens/nearby-screen.tsx",
                                        lineNumber: 386,
                                        columnNumber: 15
                            ...
                            manualOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Dropdown, {
                                        ...
                                        options: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATES"].map((s)=>({
                                                value: s.id,
                                                label: s.name[lang]
                                            }))
                                    }, void 0, false, {
                        ...
                        lineNumber: 364,
                        columnNumber: 11
                    }, this) : loc && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            isSpeaking ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].stop[lang] : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].listen[lang]
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/components/screens/nearby-screen.tsx",
                                        lineNumber: 452,
                            ...
                            manualOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].changeLocation[lang]
                                    }, void 0, false, {
                                        fileName: "[project]/components/screens/nearby-screen.tsx",
                                        lineNumber: 499,
                                        columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: FILTERS.map((f)=>{
                                    ...
                                    const label = f.id === 'All' ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].all[lang] : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find((c)=>c.id === f.id)?.label[lang] ?? f.id;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>{
                                            setFilter(f.id);
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UI"].nearbyPlaces[lang]
                                    }, void 0, false, {
                                        fileName: "[project]/components/screens/nearby-screen.tsx",
                                        lineNumber: 565,
                                        columnNumber: 17
                            ...
                            filtered.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EmptyState"], {
                                ...
                                children: filtered.map(({ p, km }, i)=>{
                                    const cat = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nearby$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES"].find((c)=>c.id === p.type);
...
_s(NearbyScreen, "qppV3tLt5Nl+O0eMmhJNCPBttgs=", false, function() {
    return [
...
//# sourceMappingURL=_1ev4c0n._.js.map